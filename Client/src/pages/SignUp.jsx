...
const SignUp = () => {
  ...
  const {setUser , setIsLoggedIn , setEmail} = InitialState();
  ...
  return (
    ...
    <form id="contactform" className='h-full space-y-9 flex flex-col' onSubmit={send}>

      <div className="inp">
      <div className='text-center text-3xl mt-16 text-white' >Sign Up </div>
    ...
    <div class="inp">
      <span class="inline-flex items-center px-3 text-gray-900 bg-gray-200 border rounded-e-0 border-gray-300 rounded-s-md">
    ...
    >
      <span className='siz'>Sign up</span>
